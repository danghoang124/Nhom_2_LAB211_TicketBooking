 ...
 *
 * <p>Generates all CSV seed data files required by the system:
 * <ul>
 ...
 * </ul>
 *
 * <p>Requires Java 17+ (uses records).
 *
 * <p>Usage:
 * <pre>
...
public class DataGenerator {
    ...
    private static final String[] SECTION_TYPES =
            {"VIP", "STANDARD", "STANDING", "ECONOMY_LOWER"};
    ...
    private static final long[] SECTION_PRICES =
        {500_000L, 200_000L, 80_000L, 100_000L};
     ...
     *
     * <p>Formula: 2,870 seats/stadium × 4 matches × 3 stadiums = <b>34,440 rows</b>
     * — well above the 10,000 minimum requirement.
     *
     * <p>All seats are initialised as AVAILABLE with version = 0.
     */
    ...
    /**
     * Generates {@code count} fans with realistic Vietnamese names and unique usernames.
    ...
    static List<Fan> generateFans(int count) {
        ...
        for (int i = 1; i <= count; i++) {
            ...
            String phone    = "0" + (900_000_000 + RNG.nextInt(99_999_999));
